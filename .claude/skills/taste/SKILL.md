---
name: taste
description: Visual style and consistent design language for landing pages, portfolios, and redesigns - the anti-slop skill that keeps this product from looking like a generic AI website. Use when defining or refining the product's visual identity and styling. NOT for layout/typography/color system selection (use ui-ux-pro-max), structural direction (use frontend-design), or motion (use animate/emil-design-eng).
---
