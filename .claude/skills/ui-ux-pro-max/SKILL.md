---
name: ui-ux-pro-max
description: "Layout, typography, color palettes, UX patterns, and design-system selection - searchable local databases (79 styles, 192 palettes, 74 font pairings, 119 UX guidelines, 25 chart types, 22 stacks). Use when CHOOSING or REVIEWING layout systems, type scales, color palettes, UX/accessibility patterns, or building a design system. NOT for overall visual identity (use taste), aesthetic direction (use frontend-design), or animations (use animate/emil-design-eng)."
---
